...
func (c *伽耶GayaCounty) BBodh_gaya菩提伽耶() feud.Barony {
	return c.菩提伽耶Bodh_gaya
}
...
func init() {
	...
	f.菩提伽耶Bodh_gaya = BBodh_gaya菩提伽耶
	f.菩提伽耶Bodh_gaya.SetParent(f)

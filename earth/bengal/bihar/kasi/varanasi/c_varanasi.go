...
type VaranasiCounty interface {
    ...
    BDurga_mandir突伽女神庙() 	feud.Barony
    BKashi_vishwanath迦尸毗湿婆那他() 	feud.Barony
...
type 波罗奈VaranasiCounty struct {
	...
	突伽女神庙Durga_mandir 	feud.Barony
	迦尸毗湿婆那他Kashi_vishwanath 	feud.Barony
...
func (c *波罗奈VaranasiCounty) BDurga_mandir突伽女神庙() feud.Barony {
	return c.突伽女神庙Durga_mandir
}
    
func (c *波罗奈VaranasiCounty) BKashi_vishwanath迦尸毗湿婆那他() feud.Barony {
	return c.迦尸毗湿婆那他Kashi_vishwanath
}
...
func init() {
	...
	f.突伽女神庙Durga_mandir = BDurga_mandir突伽女神庙
	f.突伽女神庙Durga_mandir.SetParent(f)
	
	f.迦尸毗湿婆那他Kashi_vishwanath = BKashi_vishwanath迦尸毗湿婆那他
	f.迦尸毗湿婆那他Kashi_vishwanath.SetParent(f)

...
type Trans_portageCounty interface {
    feud.County
...
type 奥涅加Trans_portageCounty struct {
	feud.BaseCounty
...
func (c *奥涅加Trans_portageCounty) BKonosha科诺沙() feud.Barony {
	return c.科诺沙Konosha
}
    
func (c *奥涅加Trans_portageCounty) BNyandoma尼扬多马() feud.Barony {
	return c.尼扬多马Nyandoma
}
    
func (c *奥涅加Trans_portageCounty) BObozerskiy奥博泽尔斯基() feud.Barony {
	return c.奥博泽尔斯基Obozerskiy
}
    
func (c *奥涅加Trans_portageCounty) BPlesetsk普列谢茨克() feud.Barony {
	return c.普列谢茨克Plesetsk
}
    
func (c *奥涅加Trans_portageCounty) BSamoded萨莫杰德() feud.Barony {
	return c.萨莫杰德Samoded
}
    
func (c *奥涅加Trans_portageCounty) BShenkursk申库尔斯克() feud.Barony {
	return c.申库尔斯克Shenkursk
}
    
func (c *奥涅加Trans_portageCounty) BSolovetsky索洛韦茨基() feud.Barony {
	return c.索洛韦茨基Solovetsky
}
    
var CTrans_portage奥涅加 Trans_portageCounty = &奥涅加Trans_portageCounty{}

func init() {
	f := CTrans_portage奥涅加.(*奥涅加Trans_portageCounty)

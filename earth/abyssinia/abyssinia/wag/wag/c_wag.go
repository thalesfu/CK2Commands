...
type WagCounty interface {
    feud.County
    BIndeher_giba因德赫吉巴() 	feud.Barony
...
func (c *瓦格WagCounty) BIndeher_giba因德赫吉巴() feud.Barony {
	return c.因德赫吉巴Indeher_giba
}
...
func init() {
	...
	f.因德赫吉巴Indeher_giba = BIndeher_giba因德赫吉巴
	f.因德赫吉巴Indeher_giba.SetParent(f)

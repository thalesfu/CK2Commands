...
func (c *达莫特DamotCounty) BYirga_chefe耶加雪夫() feud.Barony {
	return c.耶加雪夫Yirga_chefe
}
...
func init() {
	...
	f.耶加雪夫Yirga_chefe = BYirga_chefe耶加雪夫
	f.耶加雪夫Yirga_chefe.SetParent(f)

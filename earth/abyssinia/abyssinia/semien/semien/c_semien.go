...
func (c *塞米恩SemienCounty) BAmja_lebes阿姆贾勒贝斯() feud.Barony {
	return c.阿姆贾勒贝斯Amja_lebes
}
...
func (c *塞米恩SemienCounty) BOivela_mariam奥伊韦拉玛丽亚姆() feud.Barony {
	return c.奥伊韦拉玛丽亚姆Oivela_mariam
}
...
func init() {
	...
	f.阿姆贾勒贝斯Amja_lebes = BAmja_lebes阿姆贾勒贝斯
	f.阿姆贾勒贝斯Amja_lebes.SetParent(f)
	...
	f.奥伊韦拉玛丽亚姆Oivela_mariam = BOivela_mariam奥伊韦拉玛丽亚姆
	f.奥伊韦拉玛丽亚姆Oivela_mariam.SetParent(f)

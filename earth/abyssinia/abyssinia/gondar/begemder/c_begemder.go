...
type BegemderCounty interface {
    ...
    BBete_yohanis贝特约哈尼斯() 	feud.Barony
...
type 贝格姆迪尔BegemderCounty struct {
	...
	贝特约哈尼斯Bete_yohanis 	feud.Barony
...
func (c *贝格姆迪尔BegemderCounty) BBete_yohanis贝特约哈尼斯() feud.Barony {
	return c.贝特约哈尼斯Bete_yohanis
}
...
func init() {
	...
	f.贝特约哈尼斯Bete_yohanis = BBete_yohanis贝特约哈尼斯
	f.贝特约哈尼斯Bete_yohanis.SetParent(f)

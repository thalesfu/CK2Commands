...
type GojjamCounty interface {
    ...
    BGodana_mikael贡达纳迈克尔() 	feud.Barony
...
type 戈贾姆GojjamCounty struct {
	...
	贡达纳迈克尔Godana_mikael 	feud.Barony
...
func (c *戈贾姆GojjamCounty) BGodana_mikael贡达纳迈克尔() feud.Barony {
	return c.贡达纳迈克尔Godana_mikael
}
...
func init() {
	...
	f.贡达纳迈克尔Godana_mikael = BGodana_mikael贡达纳迈克尔
	f.贡达纳迈克尔Godana_mikael.SetParent(f)

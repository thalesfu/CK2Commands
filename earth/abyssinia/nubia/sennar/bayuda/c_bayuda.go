...
type BayudaCounty interface {
    ...
    BEs_soriba索里巴() 	feud.Barony
    BFaras_east东法拉斯() 	feud.Barony
...
type 拜尤达BayudaCounty struct {
	...
	索里巴Es_soriba 	feud.Barony
	东法拉斯Faras_east 	feud.Barony
...
func (c *拜尤达BayudaCounty) BEs_soriba索里巴() feud.Barony {
	return c.索里巴Es_soriba
}
    
func (c *拜尤达BayudaCounty) BFaras_east东法拉斯() feud.Barony {
	return c.东法拉斯Faras_east
}
...
func init() {
	...
	f.索里巴Es_soriba = BEs_soriba索里巴
	f.索里巴Es_soriba.SetParent(f)
	
	f.东法拉斯Faras_east = BFaras_east东法拉斯
	f.东法拉斯Faras_east.SetParent(f)

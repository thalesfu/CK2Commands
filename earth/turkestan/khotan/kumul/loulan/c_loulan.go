...
func (c *楼兰LoulanCounty) BKara_koshun喀拉库顺() feud.Barony {
	return c.喀拉库顺Kara_koshun
}
...
func init() {
	...
	f.喀拉库顺Kara_koshun = BKara_koshun喀拉库顺
	f.喀拉库顺Kara_koshun.SetParent(f)

...
func (c *马德米尼亚UrgenchCounty) BKizil_agir克孜尔阿吉尔() feud.Barony {
	return c.克孜尔阿吉尔Kizil_agir
}
...
func init() {
	...
	f.克孜尔阿吉尔Kizil_agir = BKizil_agir克孜尔阿吉尔
	f.克孜尔阿吉尔Kizil_agir.SetParent(f)

...
type ChagaiCounty interface {
    ...
    BKashmir_kili迦湿弥罗吉梨() 	feud.Barony
...
type 查盖ChagaiCounty struct {
	...
	迦湿弥罗吉梨Kashmir_kili 	feud.Barony
...
func (c *查盖ChagaiCounty) BKashmir_kili迦湿弥罗吉梨() feud.Barony {
	return c.迦湿弥罗吉梨Kashmir_kili
}
...
func init() {
	...
	f.迦湿弥罗吉梨Kashmir_kili = BKashmir_kili迦湿弥罗吉梨
	f.迦湿弥罗吉梨Kashmir_kili.SetParent(f)

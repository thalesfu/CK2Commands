...
func (c *法拉瓦Kara_kumCounty) BFarava法拉瓦() feud.Barony {
	return c.法拉瓦Farava
}
    
func (c *法拉瓦Kara_kumCounty) BGazanjyk卡赞吉克() feud.Barony {
	return c.卡赞吉克Gazanjyk
}
    
func (c *法拉瓦Kara_kumCounty) BKhodzhakala霍贾卡拉() feud.Barony {
	return c.霍贾卡拉Khodzhakala
}
    
func (c *法拉瓦Kara_kumCounty) BKochevka科切夫卡() feud.Barony {
	return c.科切夫卡Kochevka
}
    
func (c *法拉瓦Kara_kumCounty) BKyzyl_arvat克孜勒阿尔瓦特() feud.Barony {
	return c.克孜勒阿尔瓦特Kyzyl_arvat
}
    
func (c *法拉瓦Kara_kumCounty) BOhk奥赫() feud.Barony {
	return c.奥赫Ohk
}
    
func (c *法拉瓦Kara_kumCounty) BToutli托特利() feud.Barony {
	return c.托特利Toutli
}
    
var CKara_kum法拉瓦 Kara_kumCounty = &法拉瓦Kara_kumCounty{}

func init() {
	f := CKara_kum法拉瓦.(*法拉瓦Kara_kumCounty)

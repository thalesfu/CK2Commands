...
type BadghisCounty interface {
    ...
    BJabal_al_adda贾巴勒阿达() 	feud.Barony
...
type 巴德吉斯BadghisCounty struct {
	...
	贾巴勒阿达Jabal_al_adda 	feud.Barony
...
func (c *巴德吉斯BadghisCounty) BJabal_al_adda贾巴勒阿达() feud.Barony {
	return c.贾巴勒阿达Jabal_al_adda
}
...
func init() {
	...
	f.贾巴勒阿达Jabal_al_adda = BJabal_al_adda贾巴勒阿达
	f.贾巴勒阿达Jabal_al_adda.SetParent(f)

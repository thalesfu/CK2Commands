...
func (c *巴姆BamCounty) BBal_chah巴拉察() feud.Barony {
	return c.巴拉察Bal_chah
}
...
func (c *巴姆BamCounty) BSol_hasan索尔哈桑() feud.Barony {
	return c.索尔哈桑Sol_hasan
}
...
func init() {
	...
	f.巴拉察Bal_chah = BBal_chah巴拉察
	f.巴拉察Bal_chah.SetParent(f)
	...
	f.索尔哈桑Sol_hasan = BSol_hasan索尔哈桑
	f.索尔哈桑Sol_hasan.SetParent(f)

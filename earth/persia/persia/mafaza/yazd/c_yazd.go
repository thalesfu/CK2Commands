...
type YazdCounty interface {
    ...
    BChak_chak恰克恰克() 	feud.Barony
    BDar_anjir达尔安吉尔() 	feud.Barony
...
type 亚兹德YazdCounty struct {
	...
	恰克恰克Chak_chak 	feud.Barony
	达尔安吉尔Dar_anjir 	feud.Barony
...
func (c *亚兹德YazdCounty) BChak_chak恰克恰克() feud.Barony {
	return c.恰克恰克Chak_chak
}
    
func (c *亚兹德YazdCounty) BDar_anjir达尔安吉尔() feud.Barony {
	return c.达尔安吉尔Dar_anjir
}
...
func init() {
	...
	f.恰克恰克Chak_chak = BChak_chak恰克恰克
	f.恰克恰克Chak_chak.SetParent(f)
	
	f.达尔安吉尔Dar_anjir = BDar_anjir达尔安吉尔
	f.达尔安吉尔Dar_anjir.SetParent(f)

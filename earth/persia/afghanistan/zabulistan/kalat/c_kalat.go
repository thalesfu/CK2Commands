...
func (c *卡拉特KalatCounty) BKot_waras库特瓦拉斯() feud.Barony {
	return c.库特瓦拉斯Kot_waras
}
...
func init() {
	...
	f.库特瓦拉斯Kot_waras = BKot_waras库特瓦拉斯
	f.库特瓦拉斯Kot_waras.SetParent(f)

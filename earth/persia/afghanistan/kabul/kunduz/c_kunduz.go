...
type KunduzCounty interface {
    ...
    BSurkh_kotal苏尔赫科塔尔() 	feud.Barony
}
...
func (c *昆都士KunduzCounty) BSurkh_kotal苏尔赫科塔尔() feud.Barony {
	return c.苏尔赫科塔尔Surkh_kotal
}
...
func init() {
	...
	f.苏尔赫科塔尔Surkh_kotal = BSurkh_kotal苏尔赫科塔尔
	f.苏尔赫科塔尔Surkh_kotal.SetParent(f)

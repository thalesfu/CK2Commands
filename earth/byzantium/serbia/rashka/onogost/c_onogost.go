...
type OnogostCounty interface {
    ...
    BDurdevi_stupovi久尔杰维斯图波维() 	feud.Barony
...
type 奥诺戈什特OnogostCounty struct {
	...
	久尔杰维斯图波维Durdevi_stupovi 	feud.Barony
...
func (c *奥诺戈什特OnogostCounty) BDurdevi_stupovi久尔杰维斯图波维() feud.Barony {
	return c.久尔杰维斯图波维Durdevi_stupovi
}
...
func init() {
	...
	f.久尔杰维斯图波维Durdevi_stupovi = BDurdevi_stupovi久尔杰维斯图波维
	f.久尔杰维斯图波维Durdevi_stupovi.SetParent(f)

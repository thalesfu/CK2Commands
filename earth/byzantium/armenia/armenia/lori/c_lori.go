...
func (c *洛里LoriCounty) BLori_berd洛里堡() feud.Barony {
	return c.洛里堡Lori_berd
}
...
func init() {
	...
	f.洛里堡Lori_berd = BLori_berd洛里堡
	f.洛里堡Lori_berd.SetParent(f)

...
type SoliCounty interface {
    feud.County
    BBilino_polje比利诺波耶() 	feud.Barony
...
func (c *乌索拉SoliCounty) BBilino_polje比利诺波耶() feud.Barony {
	return c.比利诺波耶Bilino_polje
}
...
func init() {
	...
	f.比利诺波耶Bilino_polje = BBilino_polje比利诺波耶
	f.比利诺波耶Bilino_polje.SetParent(f)

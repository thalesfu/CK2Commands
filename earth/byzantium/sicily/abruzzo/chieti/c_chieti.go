...
func (c *基耶蒂ChietiCounty) BSan_salvo圣萨尔沃() feud.Barony {
	return c.圣萨尔沃San_salvo
}
...
func init() {
	...
	f.圣萨尔沃San_salvo = BSan_salvo圣萨尔沃
	f.圣萨尔沃San_salvo.SetParent(f)

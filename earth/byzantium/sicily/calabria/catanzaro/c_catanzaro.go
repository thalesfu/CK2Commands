...
func (c *卡坦扎罗CatanzaroCounty) BNeo_castrum新堡() feud.Barony {
	return c.新堡Neo_castrum
}
...
func init() {
	...
	f.新堡Neo_castrum = BNeo_castrum新堡
	f.新堡Neo_castrum.SetParent(f)

...
type SinopeCounty interface {
    ...
    BHalys_sinope哈吕斯() 	feud.Barony
    BLaodicea_sinope劳迪基亚() 	feud.Barony
...
type 锡诺皮SinopeCounty struct {
	...
	哈吕斯Halys_sinope 	feud.Barony
	劳迪基亚Laodicea_sinope 	feud.Barony
...
func (c *锡诺皮SinopeCounty) BHalys_sinope哈吕斯() feud.Barony {
	return c.哈吕斯Halys_sinope
}
    
func (c *锡诺皮SinopeCounty) BLaodicea_sinope劳迪基亚() feud.Barony {
	return c.劳迪基亚Laodicea_sinope
}
...
func init() {
	...
	f.哈吕斯Halys_sinope = BHalys_sinope哈吕斯
	f.哈吕斯Halys_sinope.SetParent(f)
	
	f.劳迪基亚Laodicea_sinope = BLaodicea_sinope劳迪基亚
	f.劳迪基亚Laodicea_sinope.SetParent(f)

...
type CharsianonCounty interface {
    ...
    BComana_charsianon科马纳() 	feud.Barony
...
type 哈耳西亚农CharsianonCounty struct {
	...
	科马纳Comana_charsianon 	feud.Barony
...
func (c *哈耳西亚农CharsianonCounty) BComana_charsianon科马纳() feud.Barony {
	return c.科马纳Comana_charsianon
}
...
func init() {
	...
	f.科马纳Comana_charsianon = BComana_charsianon科马纳
	f.科马纳Comana_charsianon.SetParent(f)

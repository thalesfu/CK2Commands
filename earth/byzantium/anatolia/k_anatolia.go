...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/byzantium/anatolia/armenia_minor"
...
type AnatoliaKingdom interface {
    ...
    DArmenia_minor奇里乞亚() 	armenia_minor.Armenia_minorDuke
...
type 安纳托利亚AnatoliaKingdom struct {
	...
	奇里乞亚Armenia_minor 	armenia_minor.Armenia_minorDuke
...
func (k *安纳托利亚AnatoliaKingdom) DArmenia_minor奇里乞亚() armenia_minor.Armenia_minorDuke {
	return k.奇里乞亚Armenia_minor
}
...
func init() {
	...
	f.奇里乞亚Armenia_minor = armenia_minor.DArmenia_minor奇里乞亚
	f.奇里乞亚Armenia_minor.SetParent(f)

...
func (c *日托RutogCounty) BRawang_rutog热帮日土() feud.Barony {
	return c.热帮日土Rawang_rutog
}
...
func init() {
	...
	f.热帮日土Rawang_rutog = BRawang_rutog热帮日土
	f.热帮日土Rawang_rutog.SetParent(f)

...
type LehCounty interface {
    feud.County
    BChuchot_yakma宗秋亚玛() 	feud.Barony
...
func (c *列城LehCounty) BChuchot_yakma宗秋亚玛() feud.Barony {
	return c.宗秋亚玛Chuchot_yakma
}
...
func init() {
	...
	f.宗秋亚玛Chuchot_yakma = BChuchot_yakma宗秋亚玛
	f.宗秋亚玛Chuchot_yakma.SetParent(f)

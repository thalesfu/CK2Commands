...
func (c *林布旺LimbuwanCounty) BIlam_limbuwan伊拉姆() feud.Barony {
	return c.伊拉姆Ilam_limbuwan
}
...
func init() {
	...
	f.伊拉姆Ilam_limbuwan = BIlam_limbuwan伊拉姆
	f.伊拉姆Ilam_limbuwan.SetParent(f)

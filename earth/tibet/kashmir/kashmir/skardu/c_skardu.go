...
type SkarduCounty interface {
    ...
    BMadhupur_skardu摩度补罗() 	feud.Barony
...
type 锡卡都SkarduCounty struct {
	...
	摩度补罗Madhupur_skardu 	feud.Barony
...
func (c *锡卡都SkarduCounty) BMadhupur_skardu摩度补罗() feud.Barony {
	return c.摩度补罗Madhupur_skardu
}
...
func init() {
	...
	f.摩度补罗Madhupur_skardu = BMadhupur_skardu摩度补罗
	f.摩度补罗Madhupur_skardu.SetParent(f)

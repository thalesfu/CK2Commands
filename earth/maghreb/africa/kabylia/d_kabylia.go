...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/maghreb/africa/kabylia/tell_atlas"
...
type KabyliaDuke interface {
    ...
    CTell_atlas塞提夫() 	tell_atlas.Tell_atlasCounty
}
...
type 卡比利亚KabyliaDuke struct {
	...
	塞提夫Tell_atlas 	tell_atlas.Tell_atlasCounty
}
...
func (d *卡比利亚KabyliaDuke) CTell_atlas塞提夫() tell_atlas.Tell_atlasCounty {
	return d.塞提夫Tell_atlas
}
...
func init() {
	...
	f.塞提夫Tell_atlas = tell_atlas.CTell_atlas塞提夫
	f.塞提夫Tell_atlas.SetParent(f)

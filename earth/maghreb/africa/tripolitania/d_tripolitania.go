...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/maghreb/africa/tripolitania/leptis_magna"
...
type TripolitaniaDuke interface {
    ...
    CLeptis_magna大莱波蒂斯() 	leptis_magna.Leptis_magnaCounty
...
type 的黎波里塔尼亚TripolitaniaDuke struct {
	...
	大莱波蒂斯Leptis_magna 	leptis_magna.Leptis_magnaCounty
...
func (d *的黎波里塔尼亚TripolitaniaDuke) CLeptis_magna大莱波蒂斯() leptis_magna.Leptis_magnaCounty {
	return d.大莱波蒂斯Leptis_magna
}
...
func init() {
	...
	f.大莱波蒂斯Leptis_magna = leptis_magna.CLeptis_magna大莱波蒂斯
	f.大莱波蒂斯Leptis_magna.SetParent(f)

...
type TudghaCounty interface {
    ...
    BOled_amira奥莱德阿米拉() 	feud.Barony
    BOuaourhrout瓦乌尔鲁() 	feud.Barony
    BSidi_bidi西迪比迪() 	feud.Barony
...
type 图德盖TudghaCounty struct {
	...
	奥莱德阿米拉Oled_amira 	feud.Barony
	瓦乌尔鲁Ouaourhrout 	feud.Barony
	西迪比迪Sidi_bidi 	feud.Barony
...
func (c *图德盖TudghaCounty) BOled_amira奥莱德阿米拉() feud.Barony {
	return c.奥莱德阿米拉Oled_amira
}
...
func (c *图德盖TudghaCounty) BSidi_bidi西迪比迪() feud.Barony {
	return c.西迪比迪Sidi_bidi
}
...
func init() {
	...
	f.奥莱德阿米拉Oled_amira = BOled_amira奥莱德阿米拉
	f.奥莱德阿米拉Oled_amira.SetParent(f)
	
	f.瓦乌尔鲁Ouaourhrout = BOuaourhrout瓦乌尔鲁
	f.瓦乌尔鲁Ouaourhrout.SetParent(f)
	
	f.西迪比迪Sidi_bidi = BSidi_bidi西迪比迪
	f.西迪比迪Sidi_bidi.SetParent(f)

...
type Anti_atlasCounty interface {
    feud.County
...
type 萨非Anti_atlasCounty struct {
	feud.BaseCounty
...
func (c *萨非Anti_atlasCounty) BAgadir阿加迪尔() feud.Barony {
	return c.阿加迪尔Agadir
}
    
func (c *萨非Anti_atlasCounty) BAguedal阿盖达勒() feud.Barony {
	return c.阿盖达勒Aguedal
}
    
func (c *萨非Anti_atlasCounty) BAitelaouni阿伊特阿乌里() feud.Barony {
	return c.阿伊特阿乌里Aitelaouni
}
    
func (c *萨非Anti_atlasCounty) BAkermoud阿克穆德() feud.Barony {
	return c.阿克穆德Akermoud
}
    
func (c *萨非Anti_atlasCounty) BArgana艾尔加奈() feud.Barony {
	return c.艾尔加奈Argana
}
    
func (c *萨非Anti_atlasCounty) BEssaouira索维拉() feud.Barony {
	return c.索维拉Essaouira
}
    
func (c *萨非Anti_atlasCounty) BHaddraa哈德德拉() feud.Barony {
	return c.哈德德拉Haddraa
}
    
func (c *萨非Anti_atlasCounty) BIllrh安拉() feud.Barony {
	return c.安拉Illrh
}
    
func (c *萨非Anti_atlasCounty) BQumelaioun乌姆欧云() feud.Barony {
	return c.乌姆欧云Qumelaioun
}
    
func (c *萨非Anti_atlasCounty) BSafi萨非() feud.Barony {
	return c.萨非Safi
}
    
var CAnti_atlas萨非 Anti_atlasCounty = &萨非Anti_atlasCounty{}

func init() {
	f := CAnti_atlas萨非.(*萨非Anti_atlasCounty)

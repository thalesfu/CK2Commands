...
type IdjilCounty interface {
    feud.County
    BBir_um_grein比尔乌姆格兰() 	feud.Barony
...
type 比尔乌姆格兰IdjilCounty struct {
	feud.BaseCounty
	比尔乌姆格兰Bir_um_grein 	feud.Barony
...
func (c *比尔乌姆格兰IdjilCounty) BBir_um_grein比尔乌姆格兰() feud.Barony {
	return c.比尔乌姆格兰Bir_um_grein
}
...
func init() {
	...
	f.比尔乌姆格兰Bir_um_grein = BBir_um_grein比尔乌姆格兰
	f.比尔乌姆格兰Bir_um_grein.SetParent(f)

...
type FrankfurtCounty interface {
    ...
    BSt_goarshausen圣戈阿斯豪森() 	feud.Barony
...
type 法兰克福FrankfurtCounty struct {
	...
	圣戈阿斯豪森St_goarshausen 	feud.Barony
...
func (c *法兰克福FrankfurtCounty) BSt_goarshausen圣戈阿斯豪森() feud.Barony {
	return c.圣戈阿斯豪森St_goarshausen
}
...
func init() {
	...
	f.圣戈阿斯豪森St_goarshausen = BSt_goarshausen圣戈阿斯豪森
	f.圣戈阿斯豪森St_goarshausen.SetParent(f)

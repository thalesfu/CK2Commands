...
type HesseCounty interface {
    ...
    BRotenburg_hesse罗滕堡() 	feud.Barony
...
type 马堡HesseCounty struct {
	...
	罗滕堡Rotenburg_hesse 	feud.Barony
...
func (c *马堡HesseCounty) BRotenburg_hesse罗滕堡() feud.Barony {
	return c.罗滕堡Rotenburg_hesse
}
...
func init() {
	...
	f.罗滕堡Rotenburg_hesse = BRotenburg_hesse罗滕堡
	f.罗滕堡Rotenburg_hesse.SetParent(f)

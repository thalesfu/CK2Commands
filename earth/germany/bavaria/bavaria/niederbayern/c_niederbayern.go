...
type NiederbayernCounty interface {
    ...
    BSankt_englmar圣恩尔马尔() 	feud.Barony
...
type 卡姆NiederbayernCounty struct {
	...
	圣恩尔马尔Sankt_englmar 	feud.Barony
...
func (c *卡姆NiederbayernCounty) BSankt_englmar圣恩尔马尔() feud.Barony {
	return c.圣恩尔马尔Sankt_englmar
}
...
func init() {
	...
	f.圣恩尔马尔Sankt_englmar = BSankt_englmar圣恩尔马尔
	f.圣恩尔马尔Sankt_englmar.SetParent(f)

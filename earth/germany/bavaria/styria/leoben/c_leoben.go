...
func (c *埃彭施泰因LeobenCounty) BBruck_leoben布鲁克() feud.Barony {
	return c.布鲁克Bruck_leoben
}
...
func init() {
	...
	f.布鲁克Bruck_leoben = BBruck_leoben布鲁克
	f.布鲁克Bruck_leoben.SetParent(f)

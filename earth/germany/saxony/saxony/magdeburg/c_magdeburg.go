...
type MagdeburgCounty interface {
    ...
    BKloster_berge克洛斯特堡() 	feud.Barony
...
type 马格德堡MagdeburgCounty struct {
	...
	克洛斯特堡Kloster_berge 	feud.Barony
...
func (c *马格德堡MagdeburgCounty) BKloster_berge克洛斯特堡() feud.Barony {
	return c.克洛斯特堡Kloster_berge
}
...
func init() {
	...
	f.克洛斯特堡Kloster_berge = BKloster_berge克洛斯特堡
	f.克洛斯特堡Kloster_berge.SetParent(f)

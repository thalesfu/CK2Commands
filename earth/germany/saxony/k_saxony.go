...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/germany/saxony/munster_germany"
...
type SaxonyKingdom interface {
    ...
    DMunster_germany明斯特() 	munster_germany.Munster_germanyDuke
...
type 萨克森SaxonyKingdom struct {
	...
	明斯特Munster_germany 	munster_germany.Munster_germanyDuke
...
func (k *萨克森SaxonyKingdom) DMunster_germany明斯特() munster_germany.Munster_germanyDuke {
	return k.明斯特Munster_germany
}
...
func init() {
	...
	f.明斯特Munster_germany = munster_germany.DMunster_germany明斯特
	f.明斯特Munster_germany.SetParent(f)

...
func (c *萨尔布吕肯SaargauCounty) BSt_arnual圣阿努亚尔() feud.Barony {
	return c.圣阿努亚尔St_arnual
}
...
func init() {
	...
	f.圣阿努亚尔St_arnual = BSt_arnual圣阿努亚尔
	f.圣阿努亚尔St_arnual.SetParent(f)

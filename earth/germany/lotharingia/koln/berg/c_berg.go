...
func (c *贝格BergCounty) BEssen_berg埃森() feud.Barony {
	return c.埃森Essen_berg
}
...
func init() {
	...
	f.埃森Essen_berg = BEssen_berg埃森
	f.埃森Essen_berg.SetParent(f)

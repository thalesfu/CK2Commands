...
func (c *多杜古DoduguCounty) BSibi_mali西比() feud.Barony {
	return c.西比Sibi_mali
}
...
func init() {
	...
	f.西比Sibi_mali = BSibi_mali西比
	f.西比Sibi_mali.SetParent(f)

...
type PercheCounty interface {
    ...
    BNogent_le_rotrou诺让() 	feud.Barony
...
type 佩尔什PercheCounty struct {
	...
	诺让Nogent_le_rotrou 	feud.Barony
...
func (c *佩尔什PercheCounty) BNogent_le_rotrou诺让() feud.Barony {
	return c.诺让Nogent_le_rotrou
}
...
func init() {
	...
	f.诺让Nogent_le_rotrou = BNogent_le_rotrou诺让
	f.诺让Nogent_le_rotrou.SetParent(f)

...
func (c *沙特尔ChartresCounty) BLe_coudray勒库德赖() feud.Barony {
	return c.勒库德赖Le_coudray
}
...
func init() {
	...
	f.勒库德赖Le_coudray = BLe_coudray勒库德赖
	f.勒库德赖Le_coudray.SetParent(f)

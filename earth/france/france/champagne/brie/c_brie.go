...
type BrieCounty interface {
    ...
    BNogent_sur_marne诺让() 	feud.Barony
...
type 布里BrieCounty struct {
	...
	诺让Nogent_sur_marne 	feud.Barony
...
func (c *布里BrieCounty) BNogent_sur_marne诺让() feud.Barony {
	return c.诺让Nogent_sur_marne
}
...
func init() {
	...
	f.诺让Nogent_sur_marne = BNogent_sur_marne诺让
	f.诺让Nogent_sur_marne.SetParent(f)

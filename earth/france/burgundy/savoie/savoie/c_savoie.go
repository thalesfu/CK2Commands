...
func (c *萨伏依SavoieCounty) BSt_jean圣让() feud.Barony {
	return c.圣让St_jean
}
...
func init() {
	...
	f.艾克斯Aix_savoie = BAix_savoie艾克斯
	f.艾克斯Aix_savoie.SetParent(f)
	...
	f.圣让St_jean = BSt_jean圣让
	f.圣让St_jean.SetParent(f)

...
func (c *庞蒂耶夫尔PenthievreCounty) BSt_brieuc圣布里厄() feud.Barony {
	return c.圣布里厄St_brieuc
}
...
func init() {
	...
	f.圣布里厄St_brieuc = BSt_brieuc圣布里厄
	f.圣布里厄St_brieuc.SetParent(f)

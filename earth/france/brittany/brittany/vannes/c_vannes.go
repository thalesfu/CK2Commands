...
func (c *瓦讷VannesCounty) BSt_gildas圣吉尔达() feud.Barony {
	return c.圣吉尔达St_gildas
}
...
func init() {
	...
	f.圣吉尔达St_gildas = BSt_gildas圣吉尔达
	f.圣吉尔达St_gildas.SetParent(f)

...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/france/brittany/brittany/french_leon"
...
type BrittanyDuke interface {
    ...
    CFrench_leon莱昂() 	french_leon.French_leonCounty
...
type 布列塔尼BrittanyDuke struct {
	...
	莱昂French_leon 	french_leon.French_leonCounty
...
func (d *布列塔尼BrittanyDuke) CFrench_leon莱昂() french_leon.French_leonCounty {
	return d.莱昂French_leon
}
...
func init() {
	...
	f.莱昂French_leon = french_leon.CFrench_leon莱昂
	f.莱昂French_leon.SetParent(f)

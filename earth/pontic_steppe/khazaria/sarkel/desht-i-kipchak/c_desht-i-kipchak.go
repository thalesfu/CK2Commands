...
type Desht-i-kipchakCounty interface {
    feud.County
...
type 钦察草原Desht-i-kipchakCounty struct {
	feud.BaseCounty
...
func (c *钦察草原Desht-i-kipchakCounty) BBakhmut巴赫穆特() feud.Barony {
	return c.巴赫穆特Bakhmut
}
    
func (c *钦察草原Desht-i-kipchakCounty) BDobropillia多布罗皮利亚() feud.Barony {
	return c.多布罗皮利亚Dobropillia
}
    
func (c *钦察草原Desht-i-kipchakCounty) BDruzhkivka德鲁日基夫卡() feud.Barony {
	return c.德鲁日基夫卡Druzhkivka
}
    
func (c *钦察草原Desht-i-kipchakCounty) BKramatorsk克拉马托尔斯克() feud.Barony {
	return c.克拉马托尔斯克Kramatorsk
}
    
func (c *钦察草原Desht-i-kipchakCounty) BKrasne克拉斯内() feud.Barony {
	return c.克拉斯内Krasne
}
    
func (c *钦察草原Desht-i-kipchakCounty) BLyman利曼() feud.Barony {
	return c.利曼Lyman
}
    
func (c *钦察草原Desht-i-kipchakCounty) BMospyne莫斯皮诺() feud.Barony {
	return c.莫斯皮诺Mospyne
}
    
func (c *钦察草原Desht-i-kipchakCounty) BSviatohirsk斯维亚托戈尔斯克() feud.Barony {
	return c.斯维亚托戈尔斯克Sviatohirsk
}
    
var CDesht-i-kipchak钦察草原 Desht-i-kipchakCounty = &钦察草原Desht-i-kipchakCounty{}

func init() {
	f := CDesht-i-kipchak钦察草原.(*钦察草原Desht-i-kipchakCounty)
	f.BaseCounty = feud.BaseCounty{
		ID:        "564",
		Title:     "desht-i-kipchak",
		TitleName: "钦察草原",

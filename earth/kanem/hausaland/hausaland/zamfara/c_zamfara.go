...
type ZamfaraCounty interface {
    ...
    BHoro_majakai霍罗马贾凯() 	feud.Barony
...
func (c *扎姆法拉ZamfaraCounty) BHoro_majakai霍罗马贾凯() feud.Barony {
	return c.霍罗马贾凯Horo_majakai
}
...
func init() {
	...
	f.霍罗马贾凯Horo_majakai = BHoro_majakai霍罗马贾凯
	f.霍罗马贾凯Horo_majakai.SetParent(f)

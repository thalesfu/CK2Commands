...
func (c *道拉DauraCounty) BItak_udara伊塔克乌达拉() feud.Barony {
	return c.伊塔克乌达拉Itak_udara
}
...
func init() {
	...
	f.伊塔克乌达拉Itak_udara = BItak_udara伊塔克乌达拉
	f.伊塔克乌达拉Itak_udara.SetParent(f)

...
func (c *迈尔祖格MurzukCounty) BAsh_shurraf舒拉夫() feud.Barony {
	return c.舒拉夫Ash_shurraf
}
...
func init() {
	...
	f.舒拉夫Ash_shurraf = BAsh_shurraf舒拉夫
	f.舒拉夫Ash_shurraf.SetParent(f)

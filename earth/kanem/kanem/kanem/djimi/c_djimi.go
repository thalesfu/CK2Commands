...
func (c *吉米DjimiCounty) BMuli_fuli穆利富利() feud.Barony {
	return c.穆利富利Muli_fuli
}
...
func init() {
	...
	f.穆利富利Muli_fuli = BMuli_fuli穆利富利
	f.穆利富利Muli_fuli.SetParent(f)

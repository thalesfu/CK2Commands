...
type EnnediCounty interface {
    ...
    BEsh_sharafa沙拉法() 	feud.Barony
    BEt_taba塔巴() 	feud.Barony
...
type 恩内迪EnnediCounty struct {
	...
	沙拉法Esh_sharafa 	feud.Barony
	塔巴Et_taba 	feud.Barony
...
func (c *恩内迪EnnediCounty) BEsh_sharafa沙拉法() feud.Barony {
	return c.沙拉法Esh_sharafa
}
    
func (c *恩内迪EnnediCounty) BEt_taba塔巴() feud.Barony {
	return c.塔巴Et_taba
}
...
func init() {
	...
	f.沙拉法Esh_sharafa = BEsh_sharafa沙拉法
	f.沙拉法Esh_sharafa.SetParent(f)
	
	f.塔巴Et_taba = BEt_taba塔巴
	f.塔巴Et_taba.SetParent(f)

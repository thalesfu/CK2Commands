...
type MunioCounty interface {
    ...
    BIkot_enebong伊科特埃内邦() 	feud.Barony
...
type 穆尼奥MunioCounty struct {
	...
	伊科特埃内邦Ikot_enebong 	feud.Barony
...
func (c *穆尼奥MunioCounty) BIkot_enebong伊科特埃内邦() feud.Barony {
	return c.伊科特埃内邦Ikot_enebong
}
...
func init() {
	...
	f.伊科特埃内邦Ikot_enebong = BIkot_enebong伊科特埃内邦
	f.伊科特埃内邦Ikot_enebong.SetParent(f)

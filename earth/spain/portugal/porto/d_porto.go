...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/spain/portugal/porto/castelo_branco"
...
type PortoDuke interface {
    ...
    CCastelo_branco瓜尔达() 	castelo_branco.Castelo_brancoCounty
...
type 波图斯卡莱PortoDuke struct {
	...
	瓜尔达Castelo_branco 	castelo_branco.Castelo_brancoCounty
...
func (d *波图斯卡莱PortoDuke) CCastelo_branco瓜尔达() castelo_branco.Castelo_brancoCounty {
	return d.瓜尔达Castelo_branco
}
...
func init() {
	...
	f.瓜尔达Castelo_branco = castelo_branco.CCastelo_branco瓜尔达
	f.瓜尔达Castelo_branco.SetParent(f)

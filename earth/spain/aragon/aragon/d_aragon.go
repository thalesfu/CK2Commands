...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/spain/aragon/aragon/alto_aragon"
...
type AragonDuke interface {
    ...
    CAlto_aragon上阿拉贡() 	alto_aragon.Alto_aragonCounty
...
type 阿拉贡AragonDuke struct {
	...
	上阿拉贡Alto_aragon 	alto_aragon.Alto_aragonCounty
...
func (d *阿拉贡AragonDuke) CAlto_aragon上阿拉贡() alto_aragon.Alto_aragonCounty {
	return d.上阿拉贡Alto_aragon
}
...
func init() {
	...
	f.上阿拉贡Alto_aragon = alto_aragon.CAlto_aragon上阿拉贡
	f.上阿拉贡Alto_aragon.SetParent(f)

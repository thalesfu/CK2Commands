...
type AlcalaCounty interface {
    ...
    BBurgo_de_santiuste布尔戈_德桑蒂乌斯特() 	feud.Barony
...
type 阿尔卡拉AlcalaCounty struct {
	...
	布尔戈_德桑蒂乌斯特Burgo_de_santiuste 	feud.Barony
...
func (c *阿尔卡拉AlcalaCounty) BBurgo_de_santiuste布尔戈_德桑蒂乌斯特() feud.Barony {
	return c.布尔戈_德桑蒂乌斯特Burgo_de_santiuste
}
...
func init() {
	...
	f.布尔戈_德桑蒂乌斯特Burgo_de_santiuste = BBurgo_de_santiuste布尔戈_德桑蒂乌斯特
	f.布尔戈_德桑蒂乌斯特Burgo_de_santiuste.SetParent(f)

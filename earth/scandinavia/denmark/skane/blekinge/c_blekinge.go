...
type BlekingeCounty interface {
    ...
    BSolvesborg_slott瑟尔沃斯城堡() 	feud.Barony
}
...
type 布莱金厄BlekingeCounty struct {
	...
	瑟尔沃斯城堡Solvesborg_slott 	feud.Barony
}
...
func (c *布莱金厄BlekingeCounty) BSolvesborg_slott瑟尔沃斯城堡() feud.Barony {
	return c.瑟尔沃斯城堡Solvesborg_slott
}
...
func init() {
	...
	f.瑟尔沃斯城堡Solvesborg_slott = BSolvesborg_slott瑟尔沃斯城堡
	f.瑟尔沃斯城堡Solvesborg_slott.SetParent(f)

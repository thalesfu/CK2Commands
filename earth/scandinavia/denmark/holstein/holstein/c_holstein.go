...
type HolsteinCounty interface {
    ...
    BOldenburg_holstein奥尔登堡() 	feud.Barony
...
type 荷尔斯泰因HolsteinCounty struct {
	...
	奥尔登堡Oldenburg_holstein 	feud.Barony
...
func (c *荷尔斯泰因HolsteinCounty) BOldenburg_holstein奥尔登堡() feud.Barony {
	return c.奥尔登堡Oldenburg_holstein
}
...
func init() {
	...
	f.奥尔登堡Oldenburg_holstein = BOldenburg_holstein奥尔登堡
	f.奥尔登堡Oldenburg_holstein.SetParent(f)

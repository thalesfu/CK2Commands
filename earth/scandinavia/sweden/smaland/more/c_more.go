...
func (c *默雷MoreCounty) BKalmar_hus卡尔马胡斯() feud.Barony {
	return c.卡尔马胡斯Kalmar_hus
}
...
func init() {
	...
	f.卡尔马胡斯Kalmar_hus = BKalmar_hus卡尔马胡斯
	f.卡尔马胡斯Kalmar_hus.SetParent(f)

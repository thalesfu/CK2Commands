...
func (c *鲁默里克RomerikeCounty) BAsk_romerike阿斯克() feud.Barony {
	return c.阿斯克Ask_romerike
}
...
func init() {
	...
	f.阿斯克Ask_romerike = BAsk_romerike阿斯克
	f.阿斯克Ask_romerike.SetParent(f)

...
import (
	"github.com/thalesfu/CK2Commands/earth/scandinavia/finland/karelia/east_karelia"
...
type KareliaDuke interface {
    feud.Duke
    CEast_karelia波莫里耶() 	east_karelia.East_kareliaCounty
...
type 卡累利阿KareliaDuke struct {
	feud.BaseDuke
	波莫里耶East_karelia 	east_karelia.East_kareliaCounty
...
func (d *卡累利阿KareliaDuke) CEast_karelia波莫里耶() east_karelia.East_kareliaCounty {
	return d.波莫里耶East_karelia
}
...
func init() {
	...
	f.波莫里耶East_karelia = east_karelia.CEast_karelia波莫里耶
	f.波莫里耶East_karelia.SetParent(f)

...
type BirladCounty interface {
    ...
    BTargu_putnei特尔古普特纳() 	feud.Barony
...
type 伯尔拉德BirladCounty struct {
	...
	特尔古普特纳Targu_putnei 	feud.Barony
...
func (c *伯尔拉德BirladCounty) BTargu_putnei特尔古普特纳() feud.Barony {
	return c.特尔古普特纳Targu_putnei
}
...
func init() {
	...
	f.特尔古普特纳Targu_putnei = BTargu_putnei特尔古普特纳
	f.特尔古普特纳Targu_putnei.SetParent(f)

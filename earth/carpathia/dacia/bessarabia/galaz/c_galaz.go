...
type GalazCounty interface {
    ...
    BTargu_bujor特尔古布若尔() 	feud.Barony
}
...
func (c *加拉茨GalazCounty) BTargu_bujor特尔古布若尔() feud.Barony {
	return c.特尔古布若尔Targu_bujor
}
...
func init() {
	...
	f.特尔古布若尔Targu_bujor = BTargu_bujor特尔古布若尔
	f.特尔古布若尔Targu_bujor.SetParent(f)

...
type BelgorodCounty interface {
    ...
    BCetatea_alba切塔泰亚阿尔巴() 	feud.Barony
...
type 别尔哥罗德BelgorodCounty struct {
	...
	切塔泰亚阿尔巴Cetatea_alba 	feud.Barony
...
func (c *别尔哥罗德BelgorodCounty) BCetatea_alba切塔泰亚阿尔巴() feud.Barony {
	return c.切塔泰亚阿尔巴Cetatea_alba
}
...
func init() {
	...
	f.切塔泰亚阿尔巴Cetatea_alba = BCetatea_alba切塔泰亚阿尔巴
	f.切塔泰亚阿尔巴Cetatea_alba.SetParent(f)

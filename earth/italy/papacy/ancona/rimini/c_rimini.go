...
type RiminiCounty interface {
    ...
    BPoggio_berni波焦贝尔尼() 	feud.Barony
...
func (c *里米尼RiminiCounty) BPoggio_berni波焦贝尔尼() feud.Barony {
	return c.波焦贝尔尼Poggio_berni
}
...
func init() {
	...
	f.波焦贝尔尼Poggio_berni = BPoggio_berni波焦贝尔尼
	f.波焦贝尔尼Poggio_berni.SetParent(f)

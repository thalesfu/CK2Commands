...
type ChlisselbourgCounty interface {
    ...
    BLodeynoye_pole洛杰伊诺耶波列() 	feud.Barony
...
type 什利谢利堡ChlisselbourgCounty struct {
	...
	洛杰伊诺耶波列Lodeynoye_pole 	feud.Barony
...
func (c *什利谢利堡ChlisselbourgCounty) BLodeynoye_pole洛杰伊诺耶波列() feud.Barony {
	return c.洛杰伊诺耶波列Lodeynoye_pole
}
...
func init() {
	...
	f.洛杰伊诺耶波列Lodeynoye_pole = BLodeynoye_pole洛杰伊诺耶波列
	f.洛杰伊诺耶波列Lodeynoye_pole.SetParent(f)

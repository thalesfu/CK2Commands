...
type ZaozeryeCounty interface {
    ...
    BGornyy_ruchey戈尔内鲁切伊() 	feud.Barony
...
type 扎奥焦里耶ZaozeryeCounty struct {
	...
	戈尔内鲁切伊Gornyy_ruchey 	feud.Barony
...
func (c *扎奥焦里耶ZaozeryeCounty) BGornyy_ruchey戈尔内鲁切伊() feud.Barony {
	return c.戈尔内鲁切伊Gornyy_ruchey
}
...
func init() {
	...
	f.戈尔内鲁切伊Gornyy_ruchey = BGornyy_ruchey戈尔内鲁切伊
	f.戈尔内鲁切伊Gornyy_ruchey.SetParent(f)

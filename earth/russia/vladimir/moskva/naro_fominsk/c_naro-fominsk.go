...
type Naro_fominskCounty interface {
    feud.County
    BChukovo丘科沃() 	feud.Barony
    BKlimovka克利莫夫卡() 	feud.Barony
    BKubinka库宾卡() 	feud.Barony
    BLopasnya洛帕斯尼亚() 	feud.Barony
    BNaro_fominsk纳罗福明斯克() 	feud.Barony
    BTroitsk特罗伊茨克() 	feud.Barony
    BVoronovo沃罗诺沃() 	feud.Barony
}

type 纳罗福明斯克Naro_fominskCounty struct {
	feud.BaseCounty
	丘科沃Chukovo 	feud.Barony
	克利莫夫卡Klimovka 	feud.Barony
	库宾卡Kubinka 	feud.Barony
	洛帕斯尼亚Lopasnya 	feud.Barony
	纳罗福明斯克Naro_fominsk 	feud.Barony
	特罗伊茨克Troitsk 	feud.Barony
	沃罗诺沃Voronovo 	feud.Barony
}

func (c *纳罗福明斯克Naro_fominskCounty) BChukovo丘科沃() feud.Barony {
	return c.丘科沃Chukovo
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BKlimovka克利莫夫卡() feud.Barony {
	return c.克利莫夫卡Klimovka
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BKubinka库宾卡() feud.Barony {
	return c.库宾卡Kubinka
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BLopasnya洛帕斯尼亚() feud.Barony {
	return c.洛帕斯尼亚Lopasnya
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BNaro_fominsk纳罗福明斯克() feud.Barony {
	return c.纳罗福明斯克Naro_fominsk
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BTroitsk特罗伊茨克() feud.Barony {
	return c.特罗伊茨克Troitsk
}
    
func (c *纳罗福明斯克Naro_fominskCounty) BVoronovo沃罗诺沃() feud.Barony {
	return c.沃罗诺沃Voronovo
}
    
var CNaro_fominsk纳罗福明斯克 Naro_fominskCounty = &纳罗福明斯克Naro_fominskCounty{}

func init() {
	f := CNaro_fominsk纳罗福明斯克.(*纳罗福明斯克Naro_fominskCounty)
	...
	f.纳罗福明斯克Naro_fominsk = BNaro_fominsk纳罗福明斯克

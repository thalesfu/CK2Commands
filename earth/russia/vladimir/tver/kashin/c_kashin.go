...
func (c *卡申KashinCounty) BKesova_gora克索瓦戈拉() feud.Barony {
	return c.克索瓦戈拉Kesova_gora
}
...
func init() {
	...
	f.克索瓦戈拉Kesova_gora = BKesova_gora克索瓦戈拉
	f.克索瓦戈拉Kesova_gora.SetParent(f)

...
type UglichCounty interface {
    ...
    BKrasny_kholm红霍尔姆() 	feud.Barony
    BMologa莫洛加() 	feud.Barony
    BUglich乌格利奇() 	feud.Barony
    BUgliche_pole乌格利奇波列() 	feud.Barony
...
type 乌格利奇UglichCounty struct {
	...
	红霍尔姆Krasny_kholm 	feud.Barony
	莫洛加Mologa 	feud.Barony
	乌格利奇Uglich 	feud.Barony
	乌格利奇波列Ugliche_pole 	feud.Barony
...
func (c *乌格利奇UglichCounty) BKrasny_kholm红霍尔姆() feud.Barony {
	return c.红霍尔姆Krasny_kholm
}
...
func (c *乌格利奇UglichCounty) BUgliche_pole乌格利奇波列() feud.Barony {
	return c.乌格利奇波列Ugliche_pole
}
...
func init() {
	...
	f.红霍尔姆Krasny_kholm = BKrasny_kholm红霍尔姆
	f.红霍尔姆Krasny_kholm.SetParent(f)
	...
	f.乌格利奇波列Ugliche_pole = BUgliche_pole乌格利奇波列
	f.乌格利奇波列Ugliche_pole.SetParent(f)

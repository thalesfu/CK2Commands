...
type VladimirCounty interface {
    ...
    BStarodub_vladimirsky斯塔罗杜布弗拉基米尔斯基() 	feud.Barony
...
type 弗拉基米尔VladimirCounty struct {
	...
	斯塔罗杜布弗拉基米尔斯基Starodub_vladimirsky 	feud.Barony
...
func (c *弗拉基米尔VladimirCounty) BStarodub_vladimirsky斯塔罗杜布弗拉基米尔斯基() feud.Barony {
	return c.斯塔罗杜布弗拉基米尔斯基Starodub_vladimirsky
}
...
func init() {
	...
	f.斯塔罗杜布弗拉基米尔斯基Starodub_vladimirsky = BStarodub_vladimirsky斯塔罗杜布弗拉基米尔斯基
	f.斯塔罗杜布弗拉基米尔斯基Starodub_vladimirsky.SetParent(f)

...
type GorodezCounty interface {
    feud.County
    BBor博尔() 	feud.Barony
    BChistoye_pole奇斯托耶波列() 	feud.Barony
...
type 戈罗杰茨GorodezCounty struct {
	feud.BaseCounty
	博尔Bor 	feud.Barony
	奇斯托耶波列Chistoye_pole 	feud.Barony
...
func (c *戈罗杰茨GorodezCounty) BChistoye_pole奇斯托耶波列() feud.Barony {
	return c.奇斯托耶波列Chistoye_pole
}
...
func init() {
	...
	f.奇斯托耶波列Chistoye_pole = BChistoye_pole奇斯托耶波列
	f.奇斯托耶波列Chistoye_pole.SetParent(f)

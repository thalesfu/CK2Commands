...
type MeccaCounty interface {
    feud.County
    BAl_johfa约法() 	feud.Barony
    BAl_ukaz欧卡兹() 	feud.Barony
...
type 麦加MeccaCounty struct {
	feud.BaseCounty
	约法Al_johfa 	feud.Barony
	欧卡兹Al_ukaz 	feud.Barony
...
func (c *麦加MeccaCounty) BAl_johfa约法() feud.Barony {
	return c.约法Al_johfa
}
    
func (c *麦加MeccaCounty) BAl_ukaz欧卡兹() feud.Barony {
	return c.欧卡兹Al_ukaz
}
...
func init() {
	...
	f.约法Al_johfa = BAl_johfa约法
	f.约法Al_johfa.SetParent(f)
	
	f.欧卡兹Al_ukaz = BAl_ukaz欧卡兹
	f.欧卡兹Al_ukaz.SetParent(f)

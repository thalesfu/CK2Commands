...
func (c *阿里什El_arishCounty) BAbuaweigila阿布阿维吉拉() feud.Barony {
	return c.阿布阿维吉拉Abuaweigila
}
    
func (c *阿里什El_arishCounty) BArish阿里什() feud.Barony {
	return c.阿里什Arish
}
    
func (c *阿里什El_arishCounty) BBirelhamma哈迈井() feud.Barony {
	return c.哈迈井Birelhamma
}
    
func (c *阿里什El_arishCounty) BKharruba哈鲁巴() feud.Barony {
	return c.哈鲁巴Kharruba
}
    
func (c *阿里什El_arishCounty) BMasyada马察达() feud.Barony {
	return c.马察达Masyada
}
    
func (c *阿里什El_arishCounty) BMitmatna米特马纳() feud.Barony {
	return c.米特马纳Mitmatna
}
    
func (c *阿里什El_arishCounty) BTukkot图科特() feud.Barony {
	return c.图科特Tukkot
}
    
func (c *阿里什El_arishCounty) BZuwayid祖瓦德() feud.Barony {
	return c.祖瓦德Zuwayid
}
    
var CEl_arish阿里什 El_arishCounty = &阿里什El_arishCounty{}

func init() {
	f := CEl_arish阿里什.(*阿里什El_arishCounty)

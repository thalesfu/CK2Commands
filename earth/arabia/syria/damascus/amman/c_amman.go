...
type AmmanCounty interface {
    feud.County
    BAl_balqa拜勒加() 	feud.Barony
    BAmman安曼() 	feud.Barony
    BDeir_alla代尔安拉() 	feud.Barony
...
type 安曼AmmanCounty struct {
	feud.BaseCounty
	拜勒加Al_balqa 	feud.Barony
	安曼Amman 	feud.Barony
	代尔安拉Deir_alla 	feud.Barony
...
func (c *安曼AmmanCounty) BAl_balqa拜勒加() feud.Barony {
	return c.拜勒加Al_balqa
}
...
func (c *安曼AmmanCounty) BDeir_alla代尔安拉() feud.Barony {
	return c.代尔安拉Deir_alla
}
...
func init() {
	...
	f.拜勒加Al_balqa = BAl_balqa拜勒加
	f.拜勒加Al_balqa.SetParent(f)
	
	f.安曼Amman = BAmman安曼
	f.安曼Amman.SetParent(f)
	
	f.代尔安拉Deir_alla = BDeir_alla代尔安拉
	f.代尔安拉Deir_alla.SetParent(f)

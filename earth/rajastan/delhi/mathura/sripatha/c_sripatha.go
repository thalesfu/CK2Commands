...
type SripathaCounty interface {
    ...
    BDholeshwar_mahadev陀婆丽湿伐罗摩诃提婆() 	feud.Barony
...
type 室利波他SripathaCounty struct {
	...
	陀婆丽湿伐罗摩诃提婆Dholeshwar_mahadev 	feud.Barony
	补波Durpa 	feud.Barony
...
func (c *室利波他SripathaCounty) BDholeshwar_mahadev陀婆丽湿伐罗摩诃提婆() feud.Barony {
	return c.陀婆丽湿伐罗摩诃提婆Dholeshwar_mahadev
}
...
func init() {
	...
	f.陀婆丽湿伐罗摩诃提婆Dholeshwar_mahadev = BDholeshwar_mahadev陀婆丽湿伐罗摩诃提婆
	f.陀婆丽湿伐罗摩诃提婆Dholeshwar_mahadev.SetParent(f)

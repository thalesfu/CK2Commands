...
func (c *迦卢罗KarorCounty) BWan_bhachran瓦巴查兰() feud.Barony {
	return c.瓦巴查兰Wan_bhachran
}
...
func init() {
	...
	f.瓦巴查兰Wan_bhachran = BWan_bhachran瓦巴查兰
	f.瓦巴查兰Wan_bhachran.SetParent(f)

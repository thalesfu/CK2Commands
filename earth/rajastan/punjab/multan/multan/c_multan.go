...
type MultanCounty interface {
    ...
    BMakhdum_rashid玛哈图木拉希德() 	feud.Barony
...
type 木尔坦MultanCounty struct {
	...
	玛哈图木拉希德Makhdum_rashid 	feud.Barony
...
func (c *木尔坦MultanCounty) BMakhdum_rashid玛哈图木拉希德() feud.Barony {
	return c.玛哈图木拉希德Makhdum_rashid
}
...
func init() {
	...
	f.玛哈图木拉希德Makhdum_rashid = BMakhdum_rashid玛哈图木拉希德
	f.玛哈图木拉希德Makhdum_rashid.SetParent(f)

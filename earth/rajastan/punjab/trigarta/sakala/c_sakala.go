...
func (c *奢羯罗SakalaCounty) BPuran_nagar富兰那揭罗() feud.Barony {
	return c.富兰那揭罗Puran_nagar
}
...
func init() {
	...
	f.富兰那揭罗Puran_nagar = BPuran_nagar富兰那揭罗
	f.富兰那揭罗Puran_nagar.SetParent(f)

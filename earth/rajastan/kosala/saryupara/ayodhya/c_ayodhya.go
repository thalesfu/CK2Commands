...
type AyodhyaCounty interface {
    ...
    BHanuman_garhi诃奴曼姞利呬() 	feud.Barony
    BNageshwarnath那祇湿伐罗那他() 	feud.Barony
    BRam_janmabhoomi罗摩降诞处() 	feud.Barony
...
type 阿踰陀AyodhyaCounty struct {
	...
	诃奴曼姞利呬Hanuman_garhi 	feud.Barony
	那祇湿伐罗那他Nageshwarnath 	feud.Barony
	罗摩降诞处Ram_janmabhoomi 	feud.Barony
...
func (c *阿踰陀AyodhyaCounty) BHanuman_garhi诃奴曼姞利呬() feud.Barony {
	return c.诃奴曼姞利呬Hanuman_garhi
}
...
func (c *阿踰陀AyodhyaCounty) BRam_janmabhoomi罗摩降诞处() feud.Barony {
	return c.罗摩降诞处Ram_janmabhoomi
}
...
func init() {
	...
	f.诃奴曼姞利呬Hanuman_garhi = BHanuman_garhi诃奴曼姞利呬
	f.诃奴曼姞利呬Hanuman_garhi.SetParent(f)
	
	f.那祇湿伐罗那他Nageshwarnath = BNageshwarnath那祇湿伐罗那他
	f.那祇湿伐罗那他Nageshwarnath.SetParent(f)
	
	f.罗摩降诞处Ram_janmabhoomi = BRam_janmabhoomi罗摩降诞处
	f.罗摩降诞处Ram_janmabhoomi.SetParent(f)

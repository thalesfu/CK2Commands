...
type MansuraCounty interface {
    ...
    BMirpur_khas米尔布尔哈斯() 	feud.Barony
...
func (c *曼苏拉MansuraCounty) BMirpur_khas米尔布尔哈斯() feud.Barony {
	return c.米尔布尔哈斯Mirpur_khas
}
...
func init() {
	...
	f.米尔布尔哈斯Mirpur_khas = BMirpur_khas米尔布尔哈斯
	f.米尔布尔哈斯Mirpur_khas.SetParent(f)

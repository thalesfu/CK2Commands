...
func (c *提部罗DebulCounty) BLari_bandar罗利般陀() feud.Barony {
	return c.罗利般陀Lari_bandar
}
...
func init() {
	...
	f.罗利般陀Lari_bandar = BLari_bandar罗利般陀
	f.罗利般陀Lari_bandar.SetParent(f)

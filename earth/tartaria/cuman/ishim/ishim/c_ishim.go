...
func (c *伊希姆IshimCounty) BUst_ishim乌斯季_伊希姆() feud.Barony {
	return c.乌斯季_伊希姆Ust_ishim
}
...
func init() {
	...
	f.乌斯季_伊希姆Ust_ishim = BUst_ishim乌斯季_伊希姆
	f.乌斯季_伊希姆Ust_ishim.SetParent(f)

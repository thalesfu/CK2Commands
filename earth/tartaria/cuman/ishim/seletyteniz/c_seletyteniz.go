...
type SeletytenizCounty interface {
    ...
    BShubar_seletyteniz舒巴尔() 	feud.Barony
}
...
type 谢列特捷尼兹SeletytenizCounty struct {
	...
	舒巴尔Shubar_seletyteniz 	feud.Barony
}
...
func (c *谢列特捷尼兹SeletytenizCounty) BShubar_seletyteniz舒巴尔() feud.Barony {
	return c.舒巴尔Shubar_seletyteniz
}
...
func init() {
	...
	f.舒巴尔Shubar_seletyteniz = BShubar_seletyteniz舒巴尔
	f.舒巴尔Shubar_seletyteniz.SetParent(f)

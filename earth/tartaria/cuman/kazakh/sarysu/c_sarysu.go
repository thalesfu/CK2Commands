...
func (c *萨雷苏SarysuCounty) BSarysu_kazakh萨雷苏() feud.Barony {
	return c.萨雷苏Sarysu_kazakh
}
...
func init() {
	...
	f.萨雷苏Sarysu_kazakh = BSarysu_kazakh萨雷苏
	f.萨雷苏Sarysu_kazakh.SetParent(f)

...
type SaurCounty interface {
    ...
    BKarabulak_saur卡拉布拉克() 	feud.Barony
    BKaratal_saur卡拉塔尔() 	feud.Barony
...
type 萨吾尔SaurCounty struct {
	feud.BaseCounty
	达伊尔Dair 	feud.Barony
	卡拉布拉克Karabulak_saur 	feud.Barony
	卡拉塔尔Karatal_saur 	feud.Barony
...
func (c *萨吾尔SaurCounty) BKarabulak_saur卡拉布拉克() feud.Barony {
	return c.卡拉布拉克Karabulak_saur
}
    
func (c *萨吾尔SaurCounty) BKaratal_saur卡拉塔尔() feud.Barony {
	return c.卡拉塔尔Karatal_saur
}
...
func init() {
	...
	f.卡拉布拉克Karabulak_saur = BKarabulak_saur卡拉布拉克
	f.卡拉布拉克Karabulak_saur.SetParent(f)
	
	f.卡拉塔尔Karatal_saur = BKaratal_saur卡拉塔尔
	f.卡拉塔尔Karatal_saur.SetParent(f)

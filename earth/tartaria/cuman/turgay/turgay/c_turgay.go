...
type TurgayCounty interface {
    ...
    BUst_turgay乌斯季_图尔盖() 	feud.Barony
...
func (c *图尔盖TurgayCounty) BUst_turgay乌斯季_图尔盖() feud.Barony {
	return c.乌斯季_图尔盖Ust_turgay
}
...
func init() {
	...
	f.乌斯季_图尔盖Ust_turgay = BUst_turgay乌斯季_图尔盖
	f.乌斯季_图尔盖Ust_turgay.SetParent(f)

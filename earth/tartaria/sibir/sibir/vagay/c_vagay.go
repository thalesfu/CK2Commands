...
func (c *瓦盖VagayCounty) BKordon_vagay科尔东() feud.Barony {
	return c.科尔东Kordon_vagay
}
...
func init() {
	...
	f.科尔东Kordon_vagay = BKordon_vagay科尔东
	f.科尔东Kordon_vagay.SetParent(f)

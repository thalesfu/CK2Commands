...
func (c *于都斤OtukenCounty) BKhori_tumed豁里秃马惕() feud.Barony {
	return c.豁里秃马惕Khori_tumed
}
...
func init() {
	...
	f.豁里秃马惕Khori_tumed = BKhori_tumed豁里秃马惕
	f.豁里秃马惕Khori_tumed.SetParent(f)

...
import (
	"github.com/thalesfu/CK2Commands/earth/tartaria/mongolia/otuken/eastern_sayan"
...
type OtukenDuke interface {
    feud.Duke
    CEastern_sayan东萨彦() 	eastern_sayan.Eastern_sayanCounty
...
type 于都斤OtukenDuke struct {
	feud.BaseDuke
	东萨彦Eastern_sayan 	eastern_sayan.Eastern_sayanCounty
...
func (d *于都斤OtukenDuke) CEastern_sayan东萨彦() eastern_sayan.Eastern_sayanCounty {
	return d.东萨彦Eastern_sayan
}
...
func init() {
	...
	f.东萨彦Eastern_sayan = eastern_sayan.CEastern_sayan东萨彦
	f.东萨彦Eastern_sayan.SetParent(f)

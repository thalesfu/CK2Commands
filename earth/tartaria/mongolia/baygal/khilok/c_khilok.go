...
func (c *勤勒豁KhilokCounty) BMerkit_khilok篾儿乞() feud.Barony {
	return c.篾儿乞Merkit_khilok
}
...
func init() {
	...
	f.篾儿乞Merkit_khilok = BMerkit_khilok篾儿乞
	f.篾儿乞Merkit_khilok.SetParent(f)

...
func (c *圭内思GwyneddCounty) BBangor_fawr大班戈() feud.Barony {
	return c.大班戈Bangor_fawr
}
...
func init() {
	...
	f.大班戈Bangor_fawr = BBangor_fawr大班戈
	f.大班戈Bangor_fawr.SetParent(f)

...
func (c *德维得DyfedCounty) BSt_davids圣大卫() feud.Barony {
	return c.圣大卫St_davids
}
...
func init() {
	...
	f.圣大卫St_davids = BSt_davids圣大卫
	f.圣大卫St_davids.SetParent(f)

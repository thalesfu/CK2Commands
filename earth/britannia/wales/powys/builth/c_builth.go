...
type BuilthCounty interface {
    ...
    BLlanafan_fawr拉纳凡福尔() 	feud.Barony
...
type 比尔斯BuilthCounty struct {
	...
	拉纳凡福尔Llanafan_fawr 	feud.Barony
...
func (c *比尔斯BuilthCounty) BLlanafan_fawr拉纳凡福尔() feud.Barony {
	return c.拉纳凡福尔Llanafan_fawr
}
...
func init() {
	...
	f.拉纳凡福尔Llanafan_fawr = BLlanafan_fawr拉纳凡福尔
	f.拉纳凡福尔Llanafan_fawr.SetParent(f)

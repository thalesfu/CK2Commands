...
func (c *萨默塞特SomersetCounty) BCastle_cary凯里堡() feud.Barony {
	return c.凯里堡Castle_cary
}
...
func init() {
	...
	f.凯里堡Castle_cary = BCastle_cary凯里堡
	f.凯里堡Castle_cary.SetParent(f)

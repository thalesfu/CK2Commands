...
func (c *米德尔塞克斯MiddlesexCounty) BSt_pauls圣保罗() feud.Barony {
	return c.圣保罗St_pauls
}
...
func init() {
	...
	f.圣保罗St_pauls = BSt_pauls圣保罗
	f.圣保罗St_pauls.SetParent(f)

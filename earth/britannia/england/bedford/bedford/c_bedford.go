...
func (c *贝德福德BedfordCounty) BSt_albans圣奥尔本斯() feud.Barony {
	return c.圣奥尔本斯St_albans
}
...
func init() {
	...
	f.圣奥尔本斯St_albans = BSt_albans圣奥尔本斯
	f.圣奥尔本斯St_albans.SetParent(f)

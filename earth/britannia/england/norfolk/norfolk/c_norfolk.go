...
func (c *诺福克NorfolkCounty) BCastle_rising赖辛堡() feud.Barony {
	return c.赖辛堡Castle_rising
}
...
func init() {
	...
	f.赖辛堡Castle_rising = BCastle_rising赖辛堡
	f.赖辛堡Castle_rising.SetParent(f)

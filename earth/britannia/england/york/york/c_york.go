...
func (c *约克YorkCounty) BSt_peters圣彼得() feud.Barony {
	return c.圣彼得St_peters
}
...
func init() {
	...
	f.圣彼得St_peters = BSt_peters圣彼得
	f.圣彼得St_peters.SetParent(f)

...
import (
	...
	"github.com/thalesfu/CK2Commands/earth/britannia/england/durham_palatine"
...
type EnglandKingdom interface {
    ...
    DDurham_palatine达勒姆() 	durham_palatine.Durham_palatineDuke
...
type 英格兰EnglandKingdom struct {
	...
	达勒姆Durham_palatine 	durham_palatine.Durham_palatineDuke
...
func (k *英格兰EnglandKingdom) DDurham_palatine达勒姆() durham_palatine.Durham_palatineDuke {
	return k.达勒姆Durham_palatine
}
...
func init() {
	...
	f.达勒姆Durham_palatine = durham_palatine.DDurham_palatine达勒姆
	f.达勒姆Durham_palatine.SetParent(f)

...
func (c *温彻斯特WinchesterCounty) BSt_swithun圣斯威辛() feud.Barony {
	return c.圣斯威辛St_swithun
}
...
func init() {
	...
	f.圣斯威辛St_swithun = BSt_swithun圣斯威辛
	f.圣斯威辛St_swithun.SetParent(f)

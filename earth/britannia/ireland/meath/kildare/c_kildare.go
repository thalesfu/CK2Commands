...
func (c *基尔代尔KildareCounty) BSt_brigit圣布里吉德() feud.Barony {
	return c.圣布里吉德St_brigit
}
...
func init() {
	...
	f.圣布里吉德St_brigit = BSt_brigit圣布里吉德
	f.圣布里吉德St_brigit.SetParent(f)

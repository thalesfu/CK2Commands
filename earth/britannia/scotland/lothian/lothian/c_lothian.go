...
type LothianCounty interface {
    ...
    BStow_of_wedale悲谷圣地() 	feud.Barony
...
type 洛锡安LothianCounty struct {
	...
	悲谷圣地Stow_of_wedale 	feud.Barony
...
func (c *洛锡安LothianCounty) BStow_of_wedale悲谷圣地() feud.Barony {
	return c.悲谷圣地Stow_of_wedale
}
...
func init() {
	...
	f.悲谷圣地Stow_of_wedale = BStow_of_wedale悲谷圣地
	f.悲谷圣地Stow_of_wedale.SetParent(f)

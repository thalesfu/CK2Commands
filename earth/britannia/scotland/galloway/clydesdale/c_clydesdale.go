...
type ClydesdaleCounty interface {
    ...
    BSt_kentigern圣肯蒂格恩() 	feud.Barony
}
...
func (c *克莱兹代尔ClydesdaleCounty) BSt_kentigern圣肯蒂格恩() feud.Barony {
	return c.圣肯蒂格恩St_kentigern
}
...
func init() {
	...
	f.圣肯蒂格恩St_kentigern = BSt_kentigern圣肯蒂格恩
	f.圣肯蒂格恩St_kentigern.SetParent(f)
